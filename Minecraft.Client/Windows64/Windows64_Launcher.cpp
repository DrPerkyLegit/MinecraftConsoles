...
int Windows64Launcher::API_GetAccountInfo(const std::string token) {
	...
	HttpResponse response = WinsockNetLayer::DoWinHttpRequest(L"192.168.4.31", 2054, L"/getAccountInfo", L"POST", token, headers);
...
int Windows64Launcher::API_AttemptAccountRegister(const std::string _username, const std::string password, std::string& tokenOut) {
	...
	HttpResponse response = WinsockNetLayer::DoWinHttpRequest(L"192.168.4.31", 2054, L"/accountRegistration", L"POST", data, headers);
...
int Windows64Launcher::API_AttemptAccountLogin(const std::string _username, const std::string password, std::string& tokenOut)
{
	...
	HttpResponse response = WinsockNetLayer::DoWinHttpRequest(L"192.168.4.31", 2054, L"/accountLogin", L"POST", data, headers);
